...
vlog -vlog01compat -work work +incdir+D:/FPGA/FPGA_text/multiply/rtl {D:/FPGA/FPGA_text/multiply/rtl/multiply.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/FPGA_text/multiply/quartus_prj/../sim {D:/FPGA/FPGA_text/multiply/quartus_prj/../sim/tb_multiply.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_mutliply
